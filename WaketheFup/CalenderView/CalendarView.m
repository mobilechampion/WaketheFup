...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _monthAndDayTextColor       = [UIColor grayColor];
        _dayBgColorWithoutData      = [UIColor whiteColor];
        _dayBgColorWithData         = [UIColor whiteColor];
        _dayBgColorSelected         = [UIColor grayColor];
        
        _dayTxtColorWithoutData     = [UIColor grayColor];;
        _dayTxtColorWithData        = [UIColor grayColor];
